  ...
  return (
    <section className="py-20 px-6 bg-black">
      <div className="max-w-6xl mx-auto">
        {/* Curved Rectangle Container with Gradient - More Horizontal */}
